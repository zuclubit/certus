...
import { S as Sparkles, T as Trending_down, A as Arrow_right } from "../../../chunks/trending-down.js";
import { I as Icon, b as Clock, C as Chevron_down, D as Database, c as Server, a as Circle_check_big, S as Shield, T as Trending_up } from "../../../chunks/trending-up.js";
import { P as Package, R as Rocket, S as Smartphone, F as File_code } from "../../../chunks/smartphone.js";
...
function _page($$renderer) {
    ...
    },
    {
      ...
      components: [
        ...
        },
        {
          ...
          effort: "9-13 días",
          technical: "SnapStart, ARM64 Graviton4, provisioned concurrency, batch processing",
  ...
  head("126ns2y", $$renderer, ($$renderer2) => {
    $$renderer2.title(($$renderer3) => {
      $$renderer3.push(`<title>Roadmap Técnico con IA - Hergon Platform</title>`);
    });
    $$renderer2.push(`<meta name="description" content="Roadmap técnico acelerado con AI agents (Claude Code, Copilot) - 5-6 meses, 42% más rápido"/>`);
  });
  $$renderer.push(`<div class="min-h-screen bg-gradient-to-br from-neutral-50 via-white to-neutral-50"><div class="bg-gradient-to-r from-primary via-purple-600 to-pink-600 text-white py-2"><div class="container-custom mx-auto px-6 svelte-126ns2y"><div class="flex items-center justify-center gap-2 text-sm font-medium">`);
  Sparkles($$renderer, { class: "w-4 h-4" });
  $$renderer.push(`<!----> <span>Roadmap acelerado con AI Agents (Claude Code, GitHub Copilot)</span> `);
  Sparkles($$renderer, { class: "w-4 h-4" });
  $$renderer.push(`<!----></div></div></div> <section class="py-16 bg-gradient-to-br from-primary-dark via-primary to-primary-dark text-white"><div class="container-custom mx-auto px-6 svelte-126ns2y"><div class="flex items-center justify-center gap-3 mb-6">`);
  Bot($$renderer, { class: "w-12 h-12" });
  $$renderer.push(`<!----> <h1 class="text-5xl font-bold">Roadmap Técnico con IA</h1></div> <p class="text-xl text-center max-w-4xl mx-auto mb-12 text-white/90">Plan de construcción optimizado con <strong>Agentes de IA</strong> - Claude Code, GitHub
				Copilot, y más. Reducción del <strong>42%</strong> en tiempo de desarrollo.</p> <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto"><div class="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20"><div class="flex items-center gap-3 mb-3">`);
  Clock($$renderer, { class: "w-8 h-8 text-success" });
  $$renderer.push(`<!----> <div><div class="text-sm text-white/70">Duración</div> <div class="text-2xl font-bold">${escape_html(summaryStats.durationWithAI)}</div> <div class="text-xs text-white/60 line-through">${escape_html(summaryStats.durationOriginal)}</div></div></div></div> <div class="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20"><div class="flex items-center gap-3 mb-3">`);
  Trending_down($$renderer, { class: "w-8 h-8 text-success" });
  $$renderer.push(`<!----> <div><div class="text-sm text-white/70">Reducción</div> <div class="text-2xl font-bold">${escape_html(summaryStats.reduction)}</div> <div class="text-xs text-white/60">${escape_html(summaryStats.timeSavings)} ahorrados</div></div></div></div> <div class="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20"><div class="flex items-center gap-3 mb-3">`);
  Package($$renderer, { class: "w-8 h-8 text-success" });
  $$renderer.push(`<!----> <div><div class="text-sm text-white/70">Componentes</div> <div class="text-2xl font-bold">${escape_html(summaryStats.totalComponents)}</div> <div class="text-xs text-white/60">Automatizados</div></div></div></div></div> <div class="mt-12 max-w-4xl mx-auto"><div class="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20"><h3 class="text-xl font-semibold mb-6 text-center">Timeline Comparativo</h3> <div class="space-y-4"><div><div class="flex justify-between items-center mb-2"><span class="text-sm">Sin IA</span> <span class="text-sm font-semibold">${escape_html(summaryStats.effortOriginal)}</span></div> <div class="h-3 bg-white/20 rounded-full overflow-hidden"><div class="h-full bg-red-400 w-full"></div></div></div> <div><div class="flex justify-between items-center mb-2"><span class="text-sm flex items-center gap-2">`);
  Sparkles($$renderer, { class: "w-4 h-4" });
  $$renderer.push(`<!----> Con IA</span> <span class="text-sm font-semibold">${escape_html(summaryStats.effortWithAI)}</span></div> <div class="h-3 bg-white/20 rounded-full overflow-hidden"><div class="h-full bg-gradient-to-r from-success to-emerald-400 w-[58%]"></div></div></div></div></div></div> <div class="mt-12 max-w-4xl mx-auto"><div class="bg-gradient-to-br from-orange-500/20 to-red-500/20 backdrop-blur-md rounded-2xl p-8 border-2 border-orange-400"><div class="flex items-center justify-center gap-3 mb-4">`);
  Rocket($$renderer, { class: "w-8 h-8 text-orange-600" });
  $$renderer.push(`<!----> <h3 class="text-2xl font-bold text-orange-900">⚡ Opción MVP: Go-Live en 3 Meses</h3></div> <p class="text-center text-orange-800 mb-6">Fast-track para validar producto con 1-2 AFOREs piloto antes de full rollout</p> <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6"><div class="bg-white/80 backdrop-blur-sm rounded-xl p-4 text-center"><div class="text-3xl font-bold text-orange-600">3 meses</div> <div class="text-sm text-neutral-600">vs 5-6 meses Full</div></div> <div class="bg-white/80 backdrop-blur-sm rounded-xl p-4 text-center"><div class="text-3xl font-bold text-orange-600">$114K</div> <div class="text-sm text-neutral-600">vs $197K Full</div></div> <div class="bg-white/80 backdrop-blur-sm rounded-xl p-4 text-center"><div class="text-3xl font-bold text-orange-600">10 validators</div> <div class="text-sm text-neutral-600">vs 37 completos</div></div></div> <div class="bg-white/60 backdrop-blur-sm rounded-xl p-4 mb-4"><h4 class="font-semibold text-neutral-900 mb-2">✅ Incluido en MVP:</h4> <ul class="text-sm text-neutral-700 space-y-1"><li>• Infraestructura AWS completa</li> <li>• 10 Lambda Validators críticos (70% validaciones)</li> <li>• Frontend básico funcional (sin admin panel)</li> <li>• CI/CD + Testing básico</li> <li>• Go-live con 1-2 AFOREs piloto</li></ul></div> <div class="bg-white/60 backdrop-blur-sm rounded-xl p-4"><h4 class="font-semibold text-neutral-900 mb-2">📈 Estrategia Post-MVP (Meses 4-6):</h4> <ul class="text-sm text-neutral-700 space-y-1"><li>• Agregar 27 validators restantes</li> <li>• Admin panel completo</li> <li>• Frontend avanzado (charts, drag&amp;drop)</li> <li>• Compliance docs (SOC 2, ISO 27001)</li> <li>• Escalamiento a múltiples AFOREs</li></ul></div> <div class="text-center mt-6"><a href="#mvp-details" class="inline-flex items-center gap-2 px-6 py-3 bg-orange-600 hover:bg-orange-700 text-white font-semibold rounded-xl transition-colors">Ver Timeline MVP Detallado `);
  Arrow_right($$renderer, { class: "w-5 h-5" });
  $$renderer.push(`<!----></a></div></div></div></div></section> <section class="py-20"><div class="container-custom mx-auto px-6 svelte-126ns2y"><div class="max-w-6xl mx-auto"><div class="space-y-8"><!--[-->`);
  const each_array = ensure_array_like(roadmapPhases);
  for (let index = 0, $$length = each_array.length; index < $$length; index++) {
    let phase = each_array[index];
    const Icon2 = phase.icon;
    $$renderer.push(`<div${attr_class(`relative bg-white rounded-3xl shadow-xl border-2 ${stringify(phase.borderColor)} overflow-hidden transition-all duration-300 hover:shadow-2xl`, "svelte-126ns2y")}><button${attr_class(`w-full p-6 flex items-center justify-between cursor-pointer ${stringify(phase.bgColor)} hover:opacity-90 transition-opacity`, "svelte-126ns2y")}><div class="flex items-center gap-4"><div${attr_class(`w-16 h-16 rounded-2xl bg-gradient-to-br ${stringify(phase.color)} flex items-center justify-center shadow-lg`, "svelte-126ns2y")}><!---->`);
    Icon2($$renderer, { class: "w-8 h-8 text-white" });
    $$renderer.push(`<!----></div> <div class="text-left"><h3${attr_class(`text-2xl font-bold ${stringify(phase.textColor)}`, "svelte-126ns2y")}>${escape_html(index + 1)}. ${escape_html(phase.phase)}</h3> <p class="text-sm text-neutral-600 mt-1">${escape_html(phase.month)}</p> <div class="flex items-center gap-4 mt-2"><div class="flex items-center gap-2 text-sm">`);
    Sparkles($$renderer, { class: "w-4 h-4 text-success" });
    $$renderer.push(`<!----> <span class="font-semibold text-success">${escape_html(phase.duration)}</span> <span class="text-neutral-500 line-through text-xs">${escape_html(phase.durationOriginal)}</span></div> <div class="px-3 py-1 bg-success/20 text-success text-xs font-bold rounded-full">-${escape_html(phase.reduction)}</div></div></div></div> <div class="flex items-center gap-4"><div class="text-right"><div class="text-sm text-neutral-600">Esfuerzo</div> <div${attr_class(`text-xl font-bold ${stringify(phase.textColor)}`, "svelte-126ns2y")}>${escape_html(phase.effort)}</div> <div class="text-xs text-neutral-500 line-through">${escape_html(phase.effortOriginal)}</div></div> `);
    Chevron_down($$renderer, {
      class: `w-6 h-6 ${stringify(phase.textColor)} transition-transform duration-300 ${stringify(expandedPhase === index ? "rotate-180" : "")}`
    });
    $$renderer.push(`<!----></div></button> `);
    if (expandedPhase === index) {
      $$renderer.push("<!--[-->");
      $$renderer.push(`<div${attr_class(`p-6 bg-white border-t-2 ${stringify(phase.borderColor)}`, "svelte-126ns2y")}><div class="space-y-4"><!--[-->`);
      const each_array_1 = ensure_array_like(phase.components);
      for (let $$index_1 = 0, $$length2 = each_array_1.length; $$index_1 < $$length2; $$index_1++) {
        let component = each_array_1[$$index_1];
        $$renderer.push(`<div${attr_class(`p-5 bg-neutral-50 rounded-xl border border-neutral-200 hover:border-${stringify(phase.borderColor.replace("border-", ""))} transition-all duration-200`, "svelte-126ns2y")}><div class="flex items-start justify-between mb-3"><div class="flex-1"><div class="flex items-center gap-3 mb-2"><h4 class="text-lg font-semibold text-neutral-900">${escape_html(component.name)}</h4> <span${attr_class(`px-2 py-1 bg-${stringify(component.priority === "Crítico" ? "red" : component.priority === "Alto" ? "orange" : "blue")}-100 text-${stringify(component.priority === "Crítico" ? "red" : component.priority === "Alto" ? "orange" : "blue")}-700 text-xs font-semibold rounded-full`)}>${escape_html(component.priority)}</span></div> <p class="text-sm text-neutral-600 mb-3">${escape_html(component.responsibility)}</p> <div class="flex flex-wrap gap-2 mb-3"><!--[-->`);
        const each_array_2 = ensure_array_like(component.stack);
        for (let $$index = 0, $$length3 = each_array_2.length; $$index < $$length3; $$index++) {
          let tech = each_array_2[$$index];
          $$renderer.push(`<code class="px-2 py-1 bg-white border border-neutral-300 text-xs font-mono text-neutral-700 rounded">${escape_html(tech)}</code>`);
        }
        $$renderer.push(`<!--]--></div> `);
        if (component.aiBoost) {
          $$renderer.push("<!--[-->");
          $$renderer.push(`<div class="flex items-start gap-2 p-3 bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-200 rounded-lg">`);
          Sparkles($$renderer, { class: "w-4 h-4 text-purple-600 mt-0.5 flex-shrink-0" });
          $$renderer.push(`<!----> <div class="text-sm text-purple-700"><strong>IA Boost:</strong> ${escape_html(component.aiBoost)}</div></div>`);
        } else {
          $$renderer.push("<!--[!-->");
        }
        $$renderer.push(`<!--]--> <details class="mt-3"><summary class="text-sm text-neutral-600 cursor-pointer hover:text-primary">Detalles técnicos</summary> <p class="text-sm text-neutral-700 mt-2 pl-4 border-l-2 border-neutral-300">${escape_html(component.technical)}</p></details></div> <div class="text-right ml-4"><div class="text-sm text-neutral-600 mb-1">Esfuerzo</div> <div class="flex items-center gap-2">`);
        Sparkles($$renderer, { class: "w-4 h-4 text-success" });
        $$renderer.push(`<!----> <span class="text-lg font-bold text-success">${escape_html(component.effort)}</span></div> <div class="text-xs text-neutral-500 line-through mt-1">${escape_html(component.effortOriginal)}</div></div></div></div>`);
      }
  ...
  $$renderer.push(`<!--]--></div> <div class="mt-16 text-center"><div class="bg-gradient-to-r from-primary to-purple-600 text-white rounded-3xl p-12"><div class="flex items-center justify-center gap-3 mb-4">`);
  Bot($$renderer, { class: "w-12 h-12" });
  $$renderer.push(`<!----> <h2 class="text-3xl font-bold">Desarrollo Acelerado con IA</h2></div> <p class="text-xl mb-8 text-white/90">Ahorra <strong>4 meses</strong> de desarrollo con AI-powered development</p> <div class="flex items-center justify-center gap-4"><a href="/roadmap" class="px-8 py-4 bg-white text-primary font-semibold rounded-xl hover:bg-neutral-100 transition-all duration-200 flex items-center gap-2">Ver Roadmap Original `);
  Arrow_right($$renderer, { class: "w-5 h-5" });
  $$renderer.push(`<!----></a> <a href="/" class="px-8 py-4 bg-white/20 backdrop-blur-md text-white font-semibold rounded-xl hover:bg-white/30 transition-all duration-200 border border-white/30">Volver al Inicio</a></div></div></div></div></div></section></div>`);
}
export {
  _page as default
};
